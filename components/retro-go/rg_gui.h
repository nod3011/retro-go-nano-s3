...
void rg_gui_copy_buffer(int left, int top, int width, int height, int stride, const uint16_t *buffer,
                        bool transparency);
...
void rg_gui_draw_virtual_keyboard(int x_pos, int y_pos, const rg_keyboard_layout_t *map, int cursor_pos,
                                  bool partial_redraw);
